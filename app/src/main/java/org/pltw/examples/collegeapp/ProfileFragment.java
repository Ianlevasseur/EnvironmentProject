...
public class ProfileFragment extends Fragment {
    ...
    private void dispatchTakeVideoIntent() {
        ...
        if (takeVideoIntent.resolveActivity(Profile.getPackageManager()) != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText mEnterFirstName = (EditText) rootView.findViewById(R.id.enter_first_name);
        mLastName = (TextView)rootView.findViewById(R.id.last_name);
        EditText mEnterLastName = (EditText) rootView.findViewById(R.id.enter_last_name);
